    ...
    <div className="container mx-auto px-4 py-8 mb-24" style={{ marginTop: "100px" }}>
      ...
      <div className="mb-8">
        ...
        <p>
          ...
          {stadium ? stadium.location : "Location"}
        </p>
        <p>
          <span className="font-semibold">Features:</span>{" "}
          {stadium ? stadium.features.join(", ") : "Features"}
        </p>
      </div>
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <p className="font-semibold">
                      {timeSlot.startTime.time} - {timeSlot.endTime.time}
                    </p>
                    {/* <p>{timeSlot.day}</p> */}
                  </div>
                </div>
      ...
      {/* Stadium Update Form */}
      {showStadiumForm && (
        <div className="mb-8">{/* Your stadium update form component */}</div>
      )}

      {/* Time Slot Add Form */}
      {showTimeSlotForm && (
        <div className="mb-8">{/* Your time slot add form component */}</div>
      )}
    </div>
  );
};
