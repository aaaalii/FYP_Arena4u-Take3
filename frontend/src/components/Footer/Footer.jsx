  ...
  return (
    <div className="bg-slate-100">
      <div className="container mx-auto grid grid-cols-3">
        <div className="flex flex-col justify-start items-start gap-5 py-5">
          <div className="ms-9">
            <Logo color="slate-700" />
          </div>
          <div className="flex justify-start gap-5 ms-9 w-full">
            <svg
              width="43"
              height="42"
              viewBox="0 0 43 42"
          ...
          <p className="ms-9 font-bold text-sm text-center text-slate-700">
