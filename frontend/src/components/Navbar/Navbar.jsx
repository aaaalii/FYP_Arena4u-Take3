            ...
            <div className="container mx-auto lg:px-6">
                <div className="lg:w-full w-11/12 mx-auto h-full flex justify-between items-center">
                    <div className="flex flex-col gap-y-4">
                        <div className="flex items-center gap-x-2">
                            <span>
                                <NavLink
                                    to='/'
                                    className={`${styles.logo} ${styles.inActiveStyle} text-white font-semibold text-lg leading-tight`}>
                                    Arena4U
                    ...
                    {isAuthenticated ? (
                        ...
                        <NavLink to='login' className="rounded-full border border-solid border-primary bg-transparent text-lg text-white px-4 py-3 hoverBtn">
                            Login
                        </NavLink>
                        <NavLink to='signup' className="rounded-full border border-solid border-primary bg-transparent text-lg text-white px-4 py-3 hoverBtn">
                            Signup
                        </NavLink>
                    </div>
                    )}
